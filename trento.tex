...
In summary, we have developed \trento, a new initial condition model for high-energy nuclear collisions based on a flexible ansatz that deposits entropy proportional to the generalized mean of nuclear overlap density.
This functional form smoothly interpolates among a family of physically reasonable models, facilitating unbiased, empirical constraints on the nature of the initial condition through model-to-data comparison.

We explored several discrete combinations of model parameters and found that entropy deposition functionally equivalent to the geometric mean simultaneously and self-consistently fits LHC multiplicity and flow data, including proton-proton, proton-lead, and lead-lead multiplicity distributions as well as experimental flow constraints on lead-lead eccentricity harmonics.
