...
While these models each arise from a rigorous treatment of sQGP formation, their present applicability to the full range of collision systems is limited \cite{Schenke:2013dpa,Schenke:2014zha,vanderSchee:2013pia}, and explicit treatment of pre-equilibrium dynamics comes at significant computational cost.

Non-dynamical models generate initial conditions directly at the thermalization time by asserting an ansatz for entropy deposition; although they cannot explain sQGP formation, they provide the necessary input for fluid dynamical models.
