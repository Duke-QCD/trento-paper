...
Viscous relativistic fluid dynamics provides a stable, well-tested description of the time-evolution and collective behavior in high-energy
...
latest event-by-event data on higher order flow harmonics as well as many other observables \cite{Schenke:2014zha}. Its main draw back is its computational
complexity and that its applicability to smaller collision systems (e.g.~proton-proton) remains uncertain.
...
\trento\ simulations are designed with an inherent freedom in the choice of several parameters such as the nucleon density profile $\rho_\mathrm{proton}$, Gamma fluctuation parameter $k$,
