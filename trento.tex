...
\begin{figure}[t]
  ...
  \caption{
    ...
    varied.  The corresponding $T_R$ are shown for $p = 1$, 0, $-1$ (green dashed, blue solid, and red dash-dot).
  }
\end{figure}
...
\begin{figure*}[t]
  ...
  \caption{
    ...
    for reduced thickness parameters $p = 1$, 0, $-1$  (green dashed, blue solid, and red dash-dot).
    Right plot:  Ratio of the rms eccentricities
...
\begin{figure}[b!]
  ...
  \caption{
    ...
    $0.9~<~\nch/\langle\nch\rangle~<~1.1$.  Grey dashed lines represent the analogous Glauber+NBD slopes calculated
