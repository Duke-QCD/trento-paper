...
We explored several discrete combinations of model parameters and found that entropy deposition functionally equivalent to the geometric mean simultaneously fits proton-proton, proton-lead, and lead-lead multiplicity distributions at the LHC and further satisfies experimentally extracted flow constraints on lead-lead eccentricity harmonics.
