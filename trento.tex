...
projectile $A$, $B$, utilizing either a uncorrelated Woods-Saxon distribution or correlated nuclear configurations 
...
participant $i$ in nucleus $A$. Fluctuated thickness function $T_B$ follows analygously. At this point, 
it's useful to enumerate all parameters of the model and summarize its construction. 
