...
plt.hist(mult,bins,normed=True,label="Trento pp @ 2.36 TeV",histtype='step',color='cyan',linewidth=1.5)
...
plt.errorbar(x, y, fmt='o',color='blue',markeredgecolor = 'none', yerr=dyp1-dym1, label="ALICE pp @ 2.36 TeV NSD")
